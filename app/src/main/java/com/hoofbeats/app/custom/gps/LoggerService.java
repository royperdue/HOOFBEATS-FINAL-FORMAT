...
public class LoggerService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        final boolean prefsUpdated = (intent != null) && intent.getBooleanExtra(GpioFragment.UPDATED_PREFS, false);
        if (prefsUpdated) {
            handlePrefsUpdated();
        } else if (isRunning) {
            // first start
    ...
    private boolean requestLocationUpdates() {
        ...
        if (canAccessLocation()) {
            ...
            if (Logger.DEBUG) { Log.d(TAG, "[Position permission denied]"); }
        }
    ...
    private void showNotification(int mId) {
        ...
        Intent resultIntent = new Intent(this, GpioFragment.class);

        TaskStackBuilder stackBuilder = TaskStackBuilder.create(this);
        stackBuilder.addParentStack(GpioFragment.class);
