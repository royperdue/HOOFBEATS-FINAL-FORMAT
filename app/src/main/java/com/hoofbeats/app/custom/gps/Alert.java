...
public class Alert {
     ...
     * @param message Message
     */
    public static void showInfo(Context context, CharSequence title, CharSequence message) {
        AlertDialog alertDialog = initDialog(context, title, message);
     ...
     * @return AlertDialog Dialog
     */
    public static AlertDialog showAlert(Context context, CharSequence title, int layoutResource, int iconResource) {
     ...
     * @return AlertDialog Dialog
     */
    public static AlertDialog showAlert(Context context, CharSequence title, int layoutResource) {
